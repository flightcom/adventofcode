...
def main():
    ...
    for i1 in range(5):
        ...
        phase_settings[1] = i1
        for i2 in [x for x in range(5) if x not in phase_settings.values()]:
            # print('i2', i2)
            phase_settings[5] = None
            phase_settings[3] = None
            phase_settings[4] = None
            phase_settings[2] = i2
            for i3 in [x for x in range(5) if x not in phase_settings.values()]:
                # print('i3', i3)
                phase_settings[5] = None
                phase_settings[4] = None
                phase_settings[3] = i3
                for i4 in [x for x in range(5) if x not in phase_settings.values()]:
                    # print('i4', i4)
                    phase_settings[5] = None
                    phase_settings[4] = i4
                    for i5 in [x for x in range(5) if x not in phase_settings.values()]:
                        # print('i5', i5)
                        phase_settings[5] = i5
